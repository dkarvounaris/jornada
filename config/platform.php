...
/*** Configuration file for Orchid Platform ***/
...
return [
    ...
    */
    ...
    'index'         => \Ui\Enums\HubSite::Welcome->value,
    ...
    |--------------------------------------------------------------------------
    |
    | The route to access the profile page is recorded as the name of the route,
    | it will be opened by users when they want to view or edit their profile information.
    |
    */

    'profile' => \Ui\Enums\HubProfile::Welcome->value,
    ...
    */
    ...
    | allowing you to customize the part of the profile interface that is
    ...
    */
    ...
    'search'        => [
        // \App\Database\Models\User::class
    ],
    ...
    */
    ...
    | It determines whether the entire profile screen will be used or whether
    ...
    */
    ...
    'provider'      => \Core\Providers\HubServiceProvider::class,
