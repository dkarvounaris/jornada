...
return [
    ...
    */
    ...
    |
    */
    'models_namespace' => 'Database\\Models',
    'schemas_namespace' => 'Database\\Schemas',
    'queries_namespace' => 'Database\\Queries',
    'scopes_namespace' => 'Database\\Scopes',
    'repositories_namespace' => 'Database\\Repositories',
...
//        'model' => \Blueprint\Generators\ModelGenerator::class,
        ...
        // Custom Jornada Generators
        'model' => \Dev\Blueprint\Generators\ModelGenerator::class,
        'schema' => \Dev\Blueprint\Generators\SchemaModelGenerator::class,
        'query' => \Dev\Blueprint\Generators\QueryGenerator::class,
        'repository' => \Dev\Blueprint\Generators\RepositoryGenerator::class,
    ],
