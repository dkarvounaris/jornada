...
use Ui\Orchid\Layouts\Examples\ExampleElements;
...
class ExampleFieldsScreen extends Screen
{
        ...
        return [
            ...
            Layout::rows([
                ...
                Input::make('search')
                    ...
                    ->help('Text fields designed for the profile to enter search queries into.')
                    ->horizontal(),
                ...
                Input::make('email')
                    ...
                    ->help('Used to let the profile enter and edit an e-mail address')
                    ->horizontal(),
            ...
            Layout::columns([
                Layout::rows([
                    ...
                    Input::make('email')
                        ...
                        ->popover('Tooltip - hint that profile opens himself.'),
    ...
    {
        Alert::warning('Provide contextual feedback messages for typical profile actions with the handful of available and flexible alert messages.');
    }
}
