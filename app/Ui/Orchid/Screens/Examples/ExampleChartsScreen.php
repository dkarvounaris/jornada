...
namespace App\Ui\Orchid\Screens\Examples;

use Orchid\Screen\Screen;
use Orchid\Support\Facades\Layout;
use Ui\Orchid\Layouts\Examples\ChartLineExample;
use Ui\Orchid\Layouts\Examples\ChartPercentageExample;
use Ui\Orchid\Layouts\Examples\ChartPieExample;
    ...
    public function layout(): iterable
    {
        return [
            ChartLineExample::make('charts', 'Actions with a Tweet')
                ->description('The total number of interactions a profile has with a tweet. This includes all clicks on any links in the tweet (including hashtags, links, avatar, username, and expand button), retweets, replies, likes, and additions to the read list.'),

            Layout::columns([
                \Ui\Orchid\Layouts\Examples\ChartLineExample::make('charts', 'Line Chart')
                    ->description('Visualize data trends with multi-colored line graphs.'),
                \Ui\Orchid\Layouts\Examples\ChartBarExample::make('charts', 'Bar Chart')
